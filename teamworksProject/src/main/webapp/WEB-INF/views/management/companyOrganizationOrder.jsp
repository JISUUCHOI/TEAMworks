		...
		<table class="table" style="width: 80%;">
			...
			<tbody>
				<tr>
					<th scope="row">1</th>
					<td>사장</td>
					<td><button type="button" class="btn btn-info btn-primary btn-sm">수정</button> <button type="button" class="btn btn-secondary btn btn-primary btn-sm">삭제</button></td>
					<td>
				...
				<tr>
					...
					<td><button type="button" class="btn btn-warning btn btn-primary btn-sm"">추가</button></td>
					<td></td>
				</tr>
			</tbody>
		</table>
