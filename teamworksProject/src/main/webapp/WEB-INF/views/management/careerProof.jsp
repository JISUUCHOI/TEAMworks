        ...
        <div class="page">
            ...
            <div class="subpage" id="content">
                <table id="tableContent" class="table table-bordered" style="text-align: center;">
                    ...
                    <tr height="50px">
                        <th>재직기간</th>
                        <td colspan="3"> <span>${emp.hireDate}</span>&nbsp;~&nbsp;<span id=today><input type="date" style="border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"></span></td>
                    </tr>
                    <tr height="50px">
                        <th>담당업무</th>
                        <td colspan="3"><input class="form-control" type="text"style="border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"></td>
                    </tr>
                </table>
                <br>
                <br><br><br>
                <h4 align="center">상기와 같이 재직하였음을 증명합니다.</h4>
                <br>
                <br><br>
