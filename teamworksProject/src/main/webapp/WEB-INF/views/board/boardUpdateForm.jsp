        ...
        <div class="inner">
            ...
            <form id="boardEnrollForm" method="post" onSubmit="return false" enctype="multipart/form-data">
                ...
                <table class="table" width="100%">
                    <tr>
                        <th>제목</th>
                        <td colspan="5"><input type="text" id="title" name="boardTitle" class="form-control" value="${ b.boardTitle }" required></td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                    ...
                    <tr>
                        <td colspan="6">
                            <textarea id="summernote" id="content" name="boardContent" required>${ b.boardContent }</textarea>
	                            ...
	                            <div>
	                            	...
	                            	<div>
		                            	<c:forEach var="a" items="${ attachList }">
	                            			<a href="${ pageContext.servletContext.contextPath}/resources/boardUploadFiles/${ a.baChangeName }" download="${ a.baOriginName }">${ a.baOriginName }</a>
	                            			&nbsp; &nbsp; <input type="checkbox" id="deleteFile" name=delete value=${ a.baChangeName }><label for="deleteFile">삭제</label>
	                            			<br>
	                            		</c:forEach>
	                            	</div>
	                            </div>
